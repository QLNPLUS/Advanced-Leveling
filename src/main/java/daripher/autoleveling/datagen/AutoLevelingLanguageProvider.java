...
public class AutoLevelingLanguageProvider extends LanguageProvider {
  ...
  protected void addTranslations() {
    ...
    specialText(
        AutoLevelingItems.BLACKLIST_TOOL.get(),
        "tooltip",
        YELLOW + "Adds or removes entity from blacklist");
    ...
    specialText(
        AutoLevelingItems.WHITELIST_TOOL.get(),
        "tooltip",
        YELLOW + "Adds or removes entity from whitelist");
